...
class DateTimeUtils {
  ...
  static final DateFormat dateFormatFirstVariant = DateFormat.yMd();
  static final DateFormat dateFormat = DateFormat('yyyy-MM-dd');
  static final DateFormat dateFormatShort = DateFormat('dd.MM');
  static final DateFormat dateFormatDetailed = DateFormat('dd MMMM yyyy');
  ...
  static DateTime dateFromString(String date, [DateFormat? format]) {
    format ??= dateFormatWithoutYear;
    final formattedDate = format.parse(date);
